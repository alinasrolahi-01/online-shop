    ...
    return (
        <div className='absolute top-1/2 right-10 -translate-y-1/2 w-[280px] bg-white rounded-3xl shadow-2xl overflow-hidden float border border-slate-100 p-4'>
            ...
            <div className="flex items-end justify-between mt-3">
                <div>
                    <p className="text-xs text-slate-400 line-through">۵۲,۰۰۰,۰۰۰</p>
                    <p className="font-black text-indigo-600 text-base">۴۱,۶۰۰,۰۰۰ T</p>
                </div>
                <button className="bg-indigo-600 text-white text-xs font-black px-3.5 py-2 rounded-xl hover:bg-indigo-700 active:scale-95 cursor-pointer transition-all shine">افزودن</button>
        </div>
    </div >
  )
}
