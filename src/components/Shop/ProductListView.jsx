...
const ProductRow = ({ product, isWishlisted, isInCart, onToggleWishlist, onToggleCart }) => (
  <a
    href="#"
    className="product-card bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden cursor-pointer hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group flex flex-row items-stretch"
  >
    {/* Image */}
    <div className="relative w-40 sm:w-48 flex-shrink-0 bg-white overflow-hidden">
      ...
      <div className="absolute top-2 right-2 flex flex-col gap-1.5">
        ...
        {product.isNew && (
          <span className="bg-violet-500 text-white text-[10px] font-bold px-2 py-1 rounded-full shadow-sm">
            جدید
          </span>
        )}
      </div>
    ...
    <div className="flex flex-col flex-1 p-4 sm:p-5 min-w-0">
      <div className="flex items-center justify-between mb-2 gap-2">
        ...
        <div className="flex items-center gap-1 bg-amber-50 px-2 py-1 rounded-md flex-shrink-0">
      ...
      <h3 className="font-bold text-slate-800 text-sm leading-relaxed mb-2 line-clamp-2">{product.title}</h3>
      ...
      <div className="mt-auto flex items-center justify-between pt-3 border-t border-slate-50">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`w-9 h-9 rounded-full bg-slate-50 shadow-sm flex items-center justify-center transition-all hover:scale-110 ${
